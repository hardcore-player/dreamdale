...
namespace Deal.Env
{
    ...
    /// 锯木厂
    /// </summary>
    public class Building_Sawmill : Building_Mine
    {
        ...
        {
            Data_Sawmill _Data = this.GetData<Data_Sawmill>();
            ResBuilding resBuilding = ConfigManger.I.GetResBuildingCfg(BuildingEnum.Sawmill.ToString());
        ...
        {
            Data_Sawmill data_ = this.GetData<Data_Sawmill>();
        ...
        public override void OnUpdate()
        {
            ...
            {
                this.Data.Update();
                Data_Sawmill data_Sawmill = this.GetData<Data_Sawmill>();
                this.UpdateAsset(AssetEnum.Wood, data_Sawmill.Assets[AssetEnum.Wood]);
                this.checkAnimation();
            }
        }
